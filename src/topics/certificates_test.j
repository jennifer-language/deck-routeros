...
func testExpiringFromFilters() {
    def certs as list of Certificate init [
        Certificate{id: "*1", name: "old", commonName: "a", issuer: "x",
            expiresAfter: "2w", invalidAfter: "", hasPrivateKey: true,
            trusted: false, isCa: false},
        Certificate{id: "*2", name: "fresh", commonName: "b", issuer: "x",
            expiresAfter: "51w6d", invalidAfter: "", hasPrivateKey: true,
            trusted: false, isCa: false},
        Certificate{id: "*3", name: "unknown", commonName: "c", issuer: "x",
            expiresAfter: "", invalidAfter: "", hasPrivateKey: false,
            trusted: false, isCa: false}
    ];
